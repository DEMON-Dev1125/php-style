...
<body>
    ...
    <div class="container">
        ...
        $query = "SELECT id, name, description, price, created_at FROM projects ORDER BY id DESC 
        ...
        <!-- <table class='table table-hover table-responsive table-bordered'>
            ...
            <tr>
                ...
                <td><a href='update.php?id={$id}' class='btn btn-primary m-r-1em'>Edit</a><a href='#' onclick='delete_user({$id});'  class='btn btn-danger'>Delete</a></td>
            </tr>
            </tbody>
        </table> -->
